...
function milesightDeviceEncode(payload) {
	...
	if ('overcurrent_protection_settings' in payload) {
		...
		if (payload.overcurrent_protection_settings.current < 1 || payload.overcurrent_protection_settings.current > 16) {
			throw new Error('overcurrent_protection_settings.current must be between 1 and 16');
		}
