...
function milesightDeviceEncode(payload) {
    ...
    if("key1_d2d_controller_settings" in payload || "key2_d2d_controller_settings" in payload) {
        encoded = encoded.concat(setD2DControllerSettings(payload.key1_d2d_controller_settings || payload.key2_d2d_controller_settings));
    }
 ...
 * @example { "socket_control": { "status_1": 1, "status_2": 1 } }
 */
 ...
 * @example { "schedule_settings": [{ "channel": 1, "enable": 1, "use_config": 1, "monday": 1, "tuesday": 0, "wednesday": 1, "thursday": 0, "friday": 1, "saturday": 0, "sunday": 1, "execut_hour": 10, "execut_min": 5, "swtich_1_state": 1, "swtich_2_state": 1, "lock_state": 1 }] }
 */
