 ...
 * @example { "switch_status_control": { "switch_status1": 1, "switch_status2": 1 } }
 */
function setSwitchControl(switch_status_control) {
    ...
    var data = 0x00;
    var switch_bit_offset = { switch_status1: 0, switch_status2: 1 };
 ...
 * @example { "load_power": {"switch_power1": 0, "switch_power2": 1100 } }
 */
function setLoadPower(load_power) {
    var powers = [ "switch_power1", "switch_power2" ];
 ...
 * @example { "schedule_settings": [{ "schedule_id": 1, "enable": 1, "use_config": 1, "monday": 1, "tuesday": 0, "wednesday": 1, "thursday": 0, "friday": 1, "saturday": 0, "sunday": 1, "execut_hour": 10, "execut_min": 5, "switch_status1": 1, "switch_status2": 1, "lock_status": 1 }] }
 */
function setScheduleSettings(schedule) {
    ...
    var switch_bit_offset = { switch_status1: 0, switch_status2: 2 };
 ...
 * @param {number} d2d_agent_settings_array.action_status.switch values: (1: "switch1", 2: "switch2", 3: "switch1, switch2")
