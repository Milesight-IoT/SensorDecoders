...
| Button Status            | 0xFF | 0x29 |   1    | button_status1(0..1)+button_status2(1..2)<br/>button_status1,button_status2, values(0: off, 1: on)                                         |
...
| Load Power               | 0xF9 | 0xAB |   6    | button_power1(2B),button_power2(2B), range[0, 1100]                                                                                        |
