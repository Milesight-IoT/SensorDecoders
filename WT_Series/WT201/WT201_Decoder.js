...
function handle_downlink_response(channel_type, bytes, offset) {
    ...
    switch (channel_type) {
        ...
        case 0x96:
            ...
            d2d_master_config.uplink_enable = readEnableStatus(bytes[offset + 2]);
        ...
        case 0xbd:
            ...
            break;
        case 0xc1:
            var card_action_type_map = { 0: "power", 1: "plan" };
            decoded.card_config = {};
            decoded.card_config.enable = readEnableStatus(bytes[offset]);
            var card_action_type_value = readUInt8(bytes[offset + 1]);
            decoded.card_config.action_type = getValue(card_action_type_map, card_action_type_value);
            if (card_action_type_value === 1) {
            ...
            } else if (card_action_type_value === 0) {
