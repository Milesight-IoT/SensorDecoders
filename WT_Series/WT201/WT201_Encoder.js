 ...
 * @param {string} dual_plan_config.type values: (0: wake, 1: away, 2: home, 3: sleep)
 * @param {string} dual_plan_config.temperature_control_mode values: (0: heat, 1: em heat, 2: cool, 3: auto)
 * @param {string} dual_plan_config.fan_mode values: (0: auto, 1: on, 2: circulate)
...
function setPlanConfigWithDualTemperature(dual_temperature_plan_config, temperature_unit) {
    ...
    if ("heat_target_temperature" in dual_temperature_plan_config && typeof heat_target_temperature !== "number") {
        throw new Error("dual_temperature_plan_config.heat_target_temperature must be a number");
    }
    if ("heat_temperature_tolerance" in dual_temperature_plan_config && typeof heat_temperature_tolerance !== "number") {
        throw new Error("dual_temperature_plan_config.heat_temperature_tolerance must be a number");
    }
    if ("cool_target_temperature" in dual_temperature_plan_config && typeof cool_target_temperature !== "number") {
        throw new Error("dual_temperature_plan_config.cool_target_temperature must be a number");
    }
    if ("cool_temperature_tolerance" in dual_temperature_plan_config && typeof cool_temperature_tolerance !== "number") {
    ...
    buffer.writeUInt8(heat_temperature_tolerance * 10);
    buffer.writeInt16LE(cool_target_temperature * 10);
    buffer.writeUInt8(cool_temperature_tolerance * 10);
    return buffer.toBytes();
}
