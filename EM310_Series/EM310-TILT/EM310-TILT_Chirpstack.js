...
function Decode(fPort, bytes) {
    ...
    for (var i = 0; i < bytes.length; ) {
        ...
        // ANGLE
            ...
            decoded.threhold_x = (bytes[i+6] & 0x01) === 0x01 ? "trigger" : "normal";
            decoded.threhold_y = (bytes[i+6] & 0x02) === 0x02 ? "trigger" : "normal";
            decoded.threhold_z = (bytes[i+6] & 0x04) === 0x04 ? "trigger" : "normal";
            i += 7;
        } else {
            break;
        }
