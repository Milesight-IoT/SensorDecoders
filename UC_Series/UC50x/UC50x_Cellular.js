...
function decodeSensorData(bytes) {
    ...
    while (buffer.remaining() > 0) {
        ...
        // ANALOG INPUT
            ...
            var ai_mode = (mode & 0x01) === 1 ? "votage" : "current";
            var ai_value_mode = ((mode >> 1) & 0x01) === 1 ? "mutiple" : "single";
        ...
        // MODBUS
            ...
            var modbus_chn_defination = buffer.readUInt8();
            var sign = ((modbus_chn_defination >> 7) & 0x01) === 1 ? "signed" : "unsigned";
            var modbus_chn_data_type = modbus_chn_defination & 0x0f;
