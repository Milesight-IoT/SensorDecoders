...
function decodeSensorData(bytes) {
    ...
    while (buffer.remaining() > 0) {
        ...
        // MAGNET STATUS
            ...
            decoded.magnet_status = buffer.readUInt8() == 0 ? "close" : "open";
        }
        // TEMPERATURE, HUMIDITY & MAGNET STATUS HISTROY
            ...
            point.magnet_status = buffer.readUInt8() === 0 ? "close" : "open";
...
// SAMPLE 1
// var bytes = readHexString("");
