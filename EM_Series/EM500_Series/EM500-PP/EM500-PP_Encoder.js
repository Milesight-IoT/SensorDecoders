 ...
 * @param {number} pressure_calibration_config.calibration_value
 * @example { "pressure_calibration_config": { "enable": 1, "calibration_value": 23 } }
 */
function setPressureCalibrationConfig(pressure_calibration_config) {
    var enable = pressure_calibration_config.enable;
    var calibration_value = pressure_calibration_config.calibration_value;
