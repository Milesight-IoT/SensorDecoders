    ...
    switch (channel_type) {
        case 0x06: // distance_alarm
            ...
            if (alarm_type === 5 && id === 2) {
                ...
                decoded.distance_mutation_alarm.alarm_release_report_enable = readEnableStatus(alarm_release_report_enable);
                decoded.distance_mutation_alarm.mutation = max;
            } else {
                decoded.distance_alarm = {};
                decoded.distance_alarm.condition = alarm_type;
                decoded.distance_alarm.alarm_release_report_enable = readEnableStatus(alarm_release_report_enable);
