...
| Event               | 0x03 | 0xF4 |   2    | event_type(1B) + event_status(1B)<br />event_type, values: (0: counter exception, 1: node without response, 2: unaligned)<br />event_status, values: (0: alarm release, 1: alarm)                    |
